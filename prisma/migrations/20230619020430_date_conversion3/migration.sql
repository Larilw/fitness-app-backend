/*
  ...
  - You are about to alter the column `dataNascimento` on the `Usuario` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `idFirebase` on the `Usuario` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `dataPesagem` on the `Pesagem` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `dataFinal` on the `Desafio` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `dataInicio` on the `Desafio` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
